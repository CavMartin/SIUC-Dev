<div class="form-row row border mx-2 mb-2 p-2 container-entity" id="delito_{{ $index }}">
    <div class="d-flex justify-content-between align-items-center">
        <h3 class="fw-semibold">Delito #<span class="delito-index">{{ $index + 1 }}</span></h3>
        <button type="button" class="btn btn-danger btn-sm remove-instance" data-entity="delito" data-index="{{ $index }}">
            Eliminar
        </button>
    </div>
    ...
    <div class="form-group col-md-6 col-sm-12 mb-5 mt-2">
        ...
        <select class="form-select" name="delitos[{{ $index }}][tipoActuacion]" id="tipoActuacion_{{ $index }}" required>
    ...
    <div class="form-group col-md-6 col-sm-12 mb-5 mt-2">
        ...
        <input type="text" class="form-control" name="delitos[{{ $index }}][numeroActuacion]" id="numeroActuacion_{{ $index }}" placeholder="Ejemplo: 157489-2024" required>
    </div>
</div>
